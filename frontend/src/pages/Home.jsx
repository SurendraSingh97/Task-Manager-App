...
const Home = () => {
  ...
  return (
    <>
      <MainLayout>
        {!isLoggedIn ? (
          <div className='bg-gradient-to-r from-red-800 via-orange-800 to-red-900 text-white h-[40vh] py-8 text-center'>
            <h1 className='text-2xl'> Welcome to Task Manager App</h1>
            <Link to="/register" className='mt-10 text-xl block space-x-2 hover:space-x-4'>
              <span className='transition-[margin]  underline decoration-1 hover:decoration-4'>Join now to manage your tasks</span>
